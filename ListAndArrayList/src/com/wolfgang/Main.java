...
public class Main {
    ...
    // ArrayLists are resizable arrays, handles size changes automatically
    // maintains size and amount of memory reserved
    ...
    public static void printInstructions() {
        System.out.println("\nPress ");
        System.out.println("\t 0 - To prince choice options.");
    ...
    public static void modifyItem() {
        ...
        // we are deducting 1 from the item number to compensate for the user input
